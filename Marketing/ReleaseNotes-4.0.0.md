...
• New Safety screen on the watch: call your trusted contact or local emergency services in one tap, or ping your iPhone to open its emergency page.
• New watch-face complications: see your recovery streak or a live dose countdown right on your watch face and in the Smart Stack.

SAFER SESSIONS
• Optional safety check-ins: while a dose timer runs, check-ins become more noticeable, with one-tap "Get help" and "I'm safe".
...
MORE PRIVACY
• ChillMate now hides its contents in the App Switcher and while your screen is being recorded or mirrored.
...
HEALTH & RECORDS
• Your aftercare mood can sync to Apple Health's State of Mind, and sleep fills in automatically from Health.
• Attach a photo of STI test results, protected by Face ID for positive results.
• Export your private summary as a PDF for a doctor's visit.

ALSO
• A tidier More tab, a new Siri shortcut ("Check a combination in ChillMate"), duplicate-log protection, calmer iCloud messages, and many fixes under the hood.
...
• Nieuw Veiligheid-scherm op je horloge: bel met één tik je vertrouwenscontact of de hulpdiensten, of ping je iPhone om de noodpagina te openen.
• Nieuwe complicaties: zie je herstelreeks of een live dosis-aftelling direct op je wijzerplaat en in de Smart Stack.

VEILIGERE SESSIES
• Optionele veiligheidschecks: terwijl een dosistimer loopt worden check-ins duidelijker, met één tik "Hulp zoeken" of "Ik ben veilig".
...
MEER PRIVACY
• ChillMate verbergt zijn inhoud nu in de appkiezer en tijdens schermopname of -deling.
...
GEZONDHEID & DOSSIER
• Je nazorg-stemming kan syncen met Apple Health (State of Mind); slaap wordt automatisch ingevuld.
• Voeg een foto van soa-testresultaten toe, bij positieve uitslagen beschermd met Face ID.
• Exporteer je privésamenvatting als pdf voor een doktersbezoek.

EN VERDER
• Een opgeruimd Meer-tabblad, een nieuwe Siri-opdracht, bescherming tegen dubbele logs, rustigere iCloud-meldingen en veel verbeteringen onder de motorkap.
...
• Neuer Sicherheits-Bildschirm: Ruf mit einem Tipp deine Vertrauensperson oder den Notruf an, oder pinge dein iPhone, um die Notfallseite zu öffnen.
...
MEHR PRIVATSPHÄRE
• ChillMate verbirgt seine Inhalte jetzt im App-Umschalter und während Bildschirmaufnahmen.
...
AUSSERDEM
• Aufgeräumter "Mehr"-Tab, neuer Siri-Kurzbefehl, Schutz vor doppelten Logs, ruhigere iCloud-Meldungen und viele Verbesserungen unter der Haube.
...
• Nouvel écran Sécurité : appelle ta personne de confiance ou les secours en un geste, ou alerte ton iPhone pour ouvrir la page d'urgence.
• Nouvelles complications : ta série de récupération ou un compte à rebours en direct, directement sur le cadran et dans la Smart Stack.

DES SESSIONS PLUS SÛRES
• Points sécurité optionnels : pendant qu'un minuteur tourne, les rappels deviennent plus visibles, avec « Obtenir de l'aide » et « Je suis en sécurité » en un geste.
...
• ChillMate masque désormais son contenu dans le sélecteur d'apps et pendant l'enregistrement d'écran.
...
SANTÉ & DOSSIERS
• Ton humeur d'après-session peut se synchroniser avec Apple Santé (État d'esprit) ; le sommeil se remplit automatiquement.
• Ajoute une photo de tes résultats IST, protégée par Face ID en cas de résultat positif.
• Exporte ton résumé privé en PDF pour une consultation.

ET AUSSI
• Un onglet Plus réorganisé, un nouveau raccourci Siri, une protection anti-doublons, des messages iCloud plus sereins et de nombreuses corrections.
...
• Nueva pantalla de Seguridad: llama con un toque a tu persona de confianza o a emergencias, o avisa a tu iPhone para abrir la página de emergencia.
• Nuevas complicaciones: tu racha de recuperación o una cuenta atrás en directo, en la esfera y en la Smart Stack.

SESIONES MÁS SEGURAS
• Controles de seguridad opcionales: mientras corre un temporizador, los avisos se vuelven más visibles, con «Buscar ayuda» y «Estoy bien» a un toque.
...
MÁS PRIVACIDAD
• ChillMate oculta su contenido en el selector de apps y durante la grabación de pantalla.
...
SALUD Y REGISTROS
• Tu estado de ánimo puede sincronizarse con Apple Salud (Estado mental); el sueño se rellena automáticamente.
• Añade una foto de tus resultados de ITS, protegida con Face ID si son positivos.
• Exporta tu resumen privado en PDF para la consulta médica.

ADEMÁS
• Una pestaña Más reorganizada, un nuevo atajo de Siri, protección contra registros duplicados, mensajes de iCloud más tranquilos y muchas mejoras internas.
