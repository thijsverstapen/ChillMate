...
- **Written like a person, not a changelog.** Warm, direct, excited about the
  ...
  lands as tone-deaf. The iCloud and Apple Health sections in 5.1.0 are flat
  for the same reason: each admits something, and an admission told excitedly
  reads as not meaning it. They also come first, because they are the changes
  existing users meet whether they look for them or not.
...
AND ONE MORE, ABOUT APPLE HEALTH
If ChillMate wrote your nights to Apple Health, each one also carried what you took, your answers about sex and your note, where other apps with access to Health could read them. It no longer writes any of that, and this version swaps what it wrote for clean copies. It also asks for less Health access now: only what it actually uses.
...
EN NOG IETS, OVER APPLE HEALTH
Als ChillMate je nachten naar Apple Health schreef, stond bij elke nacht ook wat je nam, je antwoorden over seks en je notitie, waar andere apps met toegang tot Health ze konden lezen. Dat schrijft het niet meer, en deze versie vervangt wat het schreef door schone kopieën. Het vraagt nu ook om minder toegang: alleen wat het echt gebruikt.
...
UND NOCH ETWAS, ZU APPLE HEALTH
Wenn ChillMate deine Nächte in Apple Health gespeichert hat, stand bei jeder auch, was du genommen hast, deine Antworten zu Sex und deine Notiz – lesbar für andere Apps mit Zugriff auf Health. Das speichert es nicht mehr, und diese Version ersetzt das Gespeicherte durch saubere Kopien. Und es fragt nur noch nach dem Zugriff, den es nutzt.
...
ET UNE AUTRE, À PROPOS D'APPLE SANTÉ
Si ChillMate enregistrait tes nuits dans Apple Santé, chacune portait aussi ce que tu as pris, tes réponses sur le sexe et ta note, lisibles par d'autres apps ayant accès à Santé. Il ne les écrit plus, et cette version remplace ce qu'il avait écrit par des copies propres. Et il ne demande plus que l'accès qu'il utilise.
...
Y OTRA MÁS, SOBRE APPLE SALUD
Si ChillMate guardaba tus noches en Apple Salud, cada una llevaba también lo que tomaste, tus respuestas sobre sexo y tu nota, legibles para otras apps con acceso a Salud. Ya no escribe nada de eso, y esta versión cambia lo que escribió por copias limpias. También pide menos acceso: solo lo que de verdad usa.
