...
S = {
    ...
    "lede": "ChillMate hält deine Nächte, Pläne, Erinnerungen und Sicherheitswerkzeuge in einer privaten Übersicht auf deinem iPhone. Es ist kostenlos, es ist Open Source, und es gibt keinen Server, also gibt es keinen anderen Ort, an dem etwas davon liegen könnte.",
    ...
    "audience_p": "Chems, Hookups, oder beides. ChillMate hat dazu keine Meinung und wird dich nie bitten, eine Nacht zu rechtfertigen. Was es tut: die praktischen Teile festhalten, die du um vier Uhr morgens lieber nicht klären möchtest.",
    "audience_points": [
    ...
    "walk": [
        ("Es ordnet sich selbst", "Was aus heute Nacht auch wurde",
         "Trag eine Nacht ein und der Startbildschirm ordnet sich darum herum. Hier hat er erkannt, dass ein PEP-Gespräch sinnvoll sein könnte, und den Countdown allein nach oben gestellt. Jetzt Hilfe holen bleibt immer über allem."),
        ("Es sagt, was bekannt ist", "Und weigert sich zu sagen, es sei sicher",
         "Wähl aus, was im Spiel ist, deine eigenen Medikamente eingeschlossen, und der Risikocheck zeigt dir, was zu dieser Kombination dokumentiert ist. Es gibt kein grünes Licht. Nichts in ChillMate wird dir je sagen, dass etwas in Ordnung ist."),
        ("Ein Raum mit gedämpftem Licht", "Für den Moment, in dem es schon schiefgeht",
         "Wenig Reize, eins nach dem anderen. Starte den Atemtimer, geh die Grounding-Schritte durch, und ruf erst jemanden an, wenn du das willst."),
        ("Echte Anlaufstellen, offline", "Hilfe von Menschen, nicht von einer App",
         "Krisentelefone, sexuelle Gesundheit, Drogen, LGBTQ+ Unterstützung und praktische Hilfe für das Land, das du einstellst. Eine Liste auf deinem Handy, also auch ohne Empfang und ohne Nachschlagen."),
        ("Eine ehrliche Karte deiner Daten", "In der App, nicht nur in einer Erklärung",
         "Was auf dem Gerät liegt, was in einem verschlüsselten Backup wäre, welche Health-Kategorien du erlaubt hast, und was ChillMate nie sendet. Dafür solltest du keine Erklärung lesen müssen."),
    ],

    "night_eyebrow": "Wie es passt",
    "night_h2": "Eine Nacht, in drei Momenten.",
    "night": [
        ("Bevor du losgehst", "Entscheide, solange es leicht ist",
         "Lass die Kombination vom Risikocheck ansehen, halt fest, worauf du Lust hast und worauf nicht, und starte einen Check-in-Timer. Fünf Minuten jetzt, solange du klar bist und noch nichts passiert ist."),
        ("Wenn du unterwegs bist", "Ein Tipp, nichts tippen",
         "Der Timer fragt, ob alles gut ist. Mir geht's gut ist ein Tipp. Hilfe holen ist der andere, und der kennt deine Vertrauensperson und die richtige Notrufnummer für deinen Ort bereits. Deine Uhr kann für dich antworten."),
        ("Der Morgen danach", "Erinnere dich richtig",
         "Schlaf, wie es dir geht, was tatsächlich geholfen hat. Es dauert eine Minute und es ist der Teil, über den du in drei Monaten froh bist, wenn die Muster die einzige ehrliche Aufzeichnung sind, die du hast."),
    ],
    ...
    "privacy_intro": "Datenschutz ist hier keine Einstellung, die du aktivierst. Es ist die Form der App.",
    "privacy_checks": [
        "Kein Konto, keine Anmeldung. Kein Server hält dein Log, weil es keinen Server gibt.",
    ...
    "proof_p": "ChillMate ist Open Source. Jede Zeile, die deine Daten berührt, ist öffentlich, und das macht aus dem Versprechen oben etwas, das du prüfen kannst, statt etwas, wobei du mir vertrauen musst.",
    "proof_fact": "Im Code der App gibt es keinen einzigen Netzwerkaufruf. Kein Analytics-SDK, kein Crash-Reporter, nirgends eine <code>URLSession</code>. Dein Handy verlässt nur, was du antippst: ein Anruf, ein Link, eine Nachricht, die du geschrieben hast.",
    ...
    "demo_p": "Kein Screenshot davon. Dieselben 30 Kombinationen, derselbe Wortlaut, dieselbe Weigerung, etwas sicher zu nennen, hier in deinem Browser. Wähl zwei und schau.",
    ...
    "demo_empty": "Wähl mindestens zwei, um zu sehen, was die App sagen würde.",
    ...
    "footnotes": [
        "Nirgends in der App Netzwerkverkehr. Durchsuch die Repository selbst nach URLSession.",
        "Sync geht in deine eigene private CloudKit-Datenbank, nie in eine geteilte.",
        "Die PIN wird mit 200.000 PBKDF2-Runden abgeleitet und im Schlüsselbund gehalten, nie wie getippt gespeichert.",
        "Inhalte werden im App-Umschalter und bei Bildschirmaufnahme oder Spiegelung verborgen.",
        "Backups werden mit AES-GCM versiegelt, bevor sie je eine Datei berühren.",
        "Der Wortlaut von Mitteilungen kann auf dem Sperrbildschirm bewusst vage bleiben.",
        "Geschriebene Zusammenfassungen nutzen Apples Modell auf dem Gerät. Nichts verlässt das Telefon.",
        "Die 30 Kombinationen oben, genau wie die App sie führt.",
        "Das Hilfeverzeichnis für alle 10 Regionen, auf dem Gerät gehalten.",
    ],
}
