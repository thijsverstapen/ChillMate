...
S = {
    ...
    "demo_meds_ph": 'Medication name, optional',
    ...
    "demo_meds_none": 'No known group matched that.',
    ...
    "demo_empty": 'Pick something, or type a medication, to see what the app would say.',
    "demo_reset": "Clear",
